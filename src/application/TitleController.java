...
public class TitleController implements Initializable {
    ...
    private Player createPlayerFromFile(File file) {
        int pilotSkillLevel = 0, fighterSkillLevel = 0, traderSkillLevel = 0, engineerSkillLevel =
                0, investorSkillLevel = 0, money = 0, fuel = 0;
        String name = "";
        ...
        try {
            ...
            newPlayer =
                    new Player(name, pilotSkillLevel, fighterSkillLevel,
                            traderSkillLevel, engineerSkillLevel,
                            investorSkillLevel, money, fuel, cargo);
        }
        return newPlayer;
    }
        ...
        if (file != null) {
            try {
                ...
                System.out.println("This is the player: "
                        + NewGameController.getPlayer().getName());
