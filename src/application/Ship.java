...
public class Ship {
	...
	static HashMap<String, Ship> generateAllShips() {
		...
		ships.put("flea", new Ship("flea", 10, 0, 0, 0, 1, 9999, 0, 1, 2000, 25, 1));
		ships.put("gnat", new Ship("gnat", 15, 1, 0, 1, 1, 14, 2, 2, 10000, 100, 1));
		ships.put("firefly", new Ship("firefly", 20, 1, 1, 1, 1, 17, 4, 3, 25000, 100, 1));
