...
public class Resource {
     ...
     * @param MTLP
     *            the minimum tech level to produce this resource
     * @param MTLU
     *            the minimum tech level to use/sell this resource to
     * @param TTP
     *            the tech level which produces the most of this resource
     * @param base
     *            the base cost of this resource
     * @param IPL
     *            the ramping cost of this resource
     * @param var
     *            the random variance of this resource
     * @param IE
     *            the planetary event which increases the price of this resource
     * @param CR
     *            the planetary resource which makes this cheap
     * @param ER
     *            the planetary resource which makes this expensive
     * @param MTL
     *            the lowest price a random trader will buy this resource for
     * @param MTH
     *            the highest price a random trader will buy this resource for
     */
    public Resource(String name, int MTLP, int MTLU, int TTP, int base,
    ...
    /**
     * Generates all the possible resources in this universe. The resources
     * generated by this method are simply templates of resources.
     */
    private static HashMap<String, Resource> generateResources() {
        HashMap<String, Resource> internalResources =
        ...
        internalResources.put("Games", new Resource("Games", 3, 1, 6, 250, -10,
                5, "BOREDOM", "ARTISTIC", "", 160, 270));
        internalResources.put("Firearms", new Resource("Firearms", 3, 1, 5,
                1250, -75, 100, "WAR", "WARLIKE", "", 600, 1100));
        internalResources.put("Medicine", new Resource("Medicine", 4, 1, 6,
                650, -20, 10, "PLAGUE", "LOTSOFHERBS", "", 400, 700));
        internalResources.put("Machines", new Resource("Machines", 4, 3, 5,
                900, -30, 5, "LACKOFWORKERS", "", "", 600, 800));
        internalResources.put("Narcotics", new Resource("Narcotics", 5, 0, 5,
                3500, -125, 150, "BOREDOM", "WEIRDMUSHROOMS", "", 2000, 3000));
        internalResources.put("Robots", new Resource("Robots", 6, 4, 7, 5000,
                -150, 100, "LACKOFWORKERS", "", "", 3500, 5000));
