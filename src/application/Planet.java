...
public class Planet {
    ...
    String[] planetNames = { "Adipose 3", "Arcadia", "Balhoon", "Brus",
            "Boeshane", "Calufrax Minor", "Chronos", "Demon's Run", "Daemos",
            "Earth", "Eye of Orion", "Felspoon", "Flane", "Gallifrey",
            "Griophos", "House", "Jahoo", "Jalian 17", "Karn", "Krop Tor",
            "Logopolis", "Limus 4", "Mondas", "Midnight", "Messaline",
            "Medusa Cascade", "New Alexandria", "Othrys", "Overod",
            "Pyrovilia", "Pandorica", "Poosh", "Quinnis", "Ribos",
            "Rex Vox Jax", "Saturnyne", "Shan Shen", "Skaro", "Sontar",
    ...
    final String[] resources =
            { "NOSPECIALRESOURCES", "NOSPECIALRESOURCES", "NOSPECIALRESOURCES",
                    "NOSPECIALRESOURCES", "NOSPECIALRESOURCES", "MINERALRICH",
                    "MINERALRICH", "MINERALPOOR", "MINERALPOOR", "DESERT",
                    "LOTSOFWATER", "RICHSOIL", "POORSOIL", "RICHFAUNA",
                    "LIFELESS", "WEIRDMUSHROOMS", "LOTSOFHERBS", "ARTISTIC",
                    "WARLIKE" };
    ...
    /**
     * Constructs a Planet. Tech levels, resources, police presence, and
     * location are randomly picked.
     */
    public Planet() {
    ...
    public String toString() {
        return ("The name of the planet is " + name + ". It is located at ("
                + (int) planetLocation.getX() + ", "
                + (int) planetLocation.getY() + "). The tech level is "
                + planetTechLevel + ". The resource is " + planetResource
