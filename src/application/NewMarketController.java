...
public class NewMarketController implements Initializable {
    ...
    @FXML
    private Text Water, Fur, Food, Ore, Games, Firearms, Medicine, Machines,
            Narcotics, Robots;
    @FXML
    ...
    @FXML
    private Text waterTotalCost, furTotalCost, foodTotalCost, oreTotalCost,
            gamesTotalCost, firearmsTotalCost, medicineTotalCost,
            machinesTotalCost, narcoticsTotalCost, robotsTotalCost;
    ...
    @FXML
    private Text waterTotalGain, furTotalGain, foodTotalGain, oreTotalGain,
            gamesTotalGain, firearmsTotalGain, medicineTotalGain,
            machinesTotalGain, narcoticsTotalGain, robotsTotalGain;
    ...
    private Text waterCargo, furCargo, foodCargo, oreCargo, gamesCargo,
            ...
            robotsCargo;
    @FXML
    private Text totalCargo, maxCargo, totalCost, totalGain, netGainLoss,
            playerMoney;
    ...
    private void fillMaps() {
        String[] resources =
                { "Water", "Fur", "Food", "Ore", "Games", "Firearms",
    ...
    private void setPrices() {
        buyWaterPrice.setText(""
                + currentPlanet.marketplace.getBuyPrice("Water"));
        buyFurPrice.setText("" + currentPlanet.marketplace.getBuyPrice("Fur"));
        buyFoodPrice
                .setText("" + currentPlanet.marketplace.getBuyPrice("Food"));
        buyOrePrice.setText("" + currentPlanet.marketplace.getBuyPrice("Ore"));
        buyGamesPrice.setText(""
                + currentPlanet.marketplace.getBuyPrice("Games"));
        buyFirearmsPrice.setText(""
                + currentPlanet.marketplace.getBuyPrice("Firearms"));
        buyMedicinePrice.setText(""
                + currentPlanet.marketplace.getBuyPrice("Medicine"));
        buyMachinesPrice.setText(""
                + currentPlanet.marketplace.getBuyPrice("Machines"));
        buyNarcoticsPrice.setText(""
                + currentPlanet.marketplace.getBuyPrice("Narcotics"));
        buyRobotsPrice.setText(""
                + currentPlanet.marketplace.getBuyPrice("Robots"));

        sellWaterPrice.setText(""
                + currentPlanet.marketplace.getSellPrice("Water"));
        sellFurPrice
                .setText("" + currentPlanet.marketplace.getSellPrice("Fur"));
        sellFoodPrice.setText(""
                + currentPlanet.marketplace.getSellPrice("Food"));
        sellOrePrice
                .setText("" + currentPlanet.marketplace.getSellPrice("Ore"));
        sellGamesPrice.setText(""
                + currentPlanet.marketplace.getSellPrice("Games"));
        sellFirearmsPrice.setText(""
                + currentPlanet.marketplace.getSellPrice("Firearms"));
        sellMedicinePrice.setText(""
                + currentPlanet.marketplace.getSellPrice("Medicine"));
        sellMachinesPrice.setText(""
                + currentPlanet.marketplace.getSellPrice("Machines"));
        sellNarcoticsPrice.setText(""
                + currentPlanet.marketplace.getSellPrice("Narcotics"));
        sellRobotsPrice.setText(""
                + currentPlanet.marketplace.getSellPrice("Robots"));
    }
    ...
    private void setCosts() {
        waterTotalCost.setText(""
                + currentPlanet.marketplace.getBuyPrice("Water")
                * buyMap.get("Water"));
        furTotalCost.setText("" + currentPlanet.marketplace.getBuyPrice("Fur")
                * buyMap.get("Fur"));
        foodTotalCost.setText(""
                + currentPlanet.marketplace.getBuyPrice("Food")
                * buyMap.get("Food"));
        oreTotalCost.setText("" + currentPlanet.marketplace.getBuyPrice("Ore")
                * buyMap.get("Ore"));
        gamesTotalCost.setText(""
                + currentPlanet.marketplace.getBuyPrice("Games")
                * buyMap.get("Games"));
        firearmsTotalCost.setText(""
                + currentPlanet.marketplace.getBuyPrice("Firearms")
                * buyMap.get("Firearms"));
        medicineTotalCost.setText(""
                + currentPlanet.marketplace.getBuyPrice("Medicine")
                * buyMap.get("Medicine"));
        machinesTotalCost.setText(""
                + currentPlanet.marketplace.getBuyPrice("Machines")
                * buyMap.get("Machines"));
        narcoticsTotalCost.setText(""
                + currentPlanet.marketplace.getBuyPrice("Narcotics")
                * buyMap.get("Narcotics"));
        robotsTotalCost.setText(""
                + currentPlanet.marketplace.getBuyPrice("Robots")
                * buyMap.get("Robots"));
    }
    ...
    private void setGains() {
        waterTotalGain.setText(""
                + currentPlanet.marketplace.getSellPrice("Water")
                * sellMap.get("Water"));
        furTotalGain.setText("" + currentPlanet.marketplace.getSellPrice("Fur")
                * sellMap.get("Fur"));
        foodTotalGain.setText(""
                + currentPlanet.marketplace.getSellPrice("Food")
                * sellMap.get("Food"));
        oreTotalGain.setText("" + currentPlanet.marketplace.getSellPrice("Ore")
                * sellMap.get("Ore"));
        gamesTotalGain.setText(""
                + currentPlanet.marketplace.getSellPrice("Games")
                * sellMap.get("Games"));
        firearmsTotalGain.setText(""
                + currentPlanet.marketplace.getSellPrice("Firearms")
                * sellMap.get("Firearms"));
        medicineTotalGain.setText(""
                + currentPlanet.marketplace.getSellPrice("Medicine")
                * sellMap.get("Medicine"));
        machinesTotalGain.setText(""
                + currentPlanet.marketplace.getSellPrice("Machines")
                * sellMap.get("Machines"));
        narcoticsTotalGain.setText(""
                + currentPlanet.marketplace.getSellPrice("Narcotics")
                * sellMap.get("Narcotics"));
        robotsTotalGain.setText(""
                + currentPlanet.marketplace.getSellPrice("Robots")
                * sellMap.get("Robots"));
    }
    ...
    private void setTotals() {
        ...
        // + firearmsCost + medicineCost + machinesCost + narcoticsCost +
        // robotsCost;
        ...
        for (int i = 0; i < resources.length; i++) {
            totalcost +=
                    buyMap.get(resources[i])
                            * currentPlanet.marketplace
                                    .getBuyPrice(resources[i]);
            totalgain +=
                    sellMap.get(resources[i])
                            * currentPlanet.marketplace
                                    .getSellPrice(resources[i]);
    ...
    private void onPressCheckout(ActionEvent event) throws IOException {
        ...
        if ((Integer.parseInt(totalGain.getText()) - Integer.parseInt(totalCost
                .getText()))
                + Universe.player.getMoney() >= 0) {
            Universe.player
                    .setMoney((Integer.parseInt(totalGain.getText()) - Integer
                            .parseInt(totalCost.getText()))
                            + Universe.player.getMoney());
    ...
    private void incrementBuyGood(Text item, Text amt, Text total, Text cargo) {
        ...
        total.setText("" + buyMap.get(item.getText())
                * currentPlanet.marketplace.getBuyPrice(item.getText()));
    ...
    private void incrementSellGood(Text item, Text amt, Text total, Text cargo) {
        if ((cargoMap.get(item.getText()) - 1) >= 0) {
            ...
            total.setText("" + sellMap.get(item.getText())
                    * currentPlanet.marketplace.getBuyPrice(item.getText()));
            cargoMap.put(item.getText(), cargoMap.get(item.getText()) - 1);
            cargo.setText("" + cargoMap.get(item.getText()));
            setTotals();
